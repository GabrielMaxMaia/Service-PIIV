...
public interface PedidoRepository extends JpaRepository<Pedido, Long>{
	...
	@Query(value ="select valor_Total from fechamento_comanda, comanda where fechamento_comanda.comanda_id = comanda.id and comanda.cod_mesa = :mesa_id and comanda.status = 'fechada'", nativeQuery = true)
